                            ...
                            >
                                ...
                                <span
                                    css={css`
                                        ...
                                        right: 0.75rem;
                                        font-size: 0.825rem;
                                        color: ${textValue.length < 8 ? theme.colors.statusRed : '#333'};
                                    `}
                                >
                                    {textValue.length ? textValue.length : 0} / 280
                                </span>
                            </div>
                            <BottomPosition>
